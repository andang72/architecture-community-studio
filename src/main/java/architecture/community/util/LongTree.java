...
public final class LongTree implements Externalizable {
     ...
     *
     * @param rootKey
     *            the value of the element node of the tree.
	...
	// New tree, so set the fields to null at element.
	keys[1] = rootKey;
	leftChildren[1] = 0;
	rightSiblings[1] = 0;
    }
	...
	// If the element key was passed in, return -1;
	if (keys[1] == childKey) {
	    return -1;
	}
     ...
     * the element is not in the tree. For example, the element element is depth 0,
     * direct children of the element element are depth 1, etc.
     *
     * @param key
     ...
     * @param startIndex
     *            the index in the tree to start searching at. Pass in the element
