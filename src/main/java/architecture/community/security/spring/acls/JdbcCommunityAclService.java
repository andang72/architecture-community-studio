...
public class JdbcCommunityAclService extends JdbcMutableAclService implements CommunityAclService {
	...
	public <T> void getFinalGrantedPermissions(Authentication authentication, Class<T> clazz, Serializable identifier,
	...
	public <T> boolean isPermissionGrantedFinally(Authentication authentication, Class<T> clazz,
			Serializable identifier, List<Permission> permissions) {
		ObjectIdentity identity = new ObjectIdentityImpl(clazz.getCanonicalName(), identifier);
	 ...
	 * @return
	 */
	public <T> boolean isPermissionGrantedFinally(Authentication authentication, ObjectIdentity identity,
	 ...
	 * @return
	 */
	public <T> boolean isPermissionGranted(Class<T> clazz, Serializable identifier, UserDetails user,
	...
	public <T> boolean isPermissionGrantedToAnonymous(Class<T> clazz, Serializable identifier,
			Permission... permissions) {
	...
	public <T> boolean isPermissionGranted(Class<T> clazz, Serializable identifier, User user,
			Permission... permissions) {
	...
	public <T> boolean isPermissionGranted(Class<T> clazz, Serializable identifier, Role role,
			Permission... permissions) {
	...
	public PermissionsBundle getPermissionBundle(Object object) {
		 ...
		 * return getPermissionBundle( SecurityHelper.getAuthentication(),
		 * Project.class, ((Project) object ).getProjectId() );
		 * }
		 */
