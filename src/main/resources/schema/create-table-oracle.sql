	...
	-- User 
		...
		COMMENT ON TABLE      "AC_UI_USER_PROPERTY"  IS '회사 프로퍼티 테이블';
		COMMENT ON COLUMN "AC_UI_USER_PROPERTY"."USER_ID" IS 'ID'; 
		COMMENT ON COLUMN "AC_UI_USER_PROPERTY"."PROPERTY_NAME" IS '프로퍼티 이름'; 
		COMMENT ON COLUMN "AC_UI_USER_PROPERTY"."PROPERTY_VALUE" IS '프로퍼티 값'; 	
