...
COMMENT ON COLUMN `AC_UI_IMAGE`.`MODIFIED_DATE` IS '수정일'; */
		...
		ALTER TABLE `AC_UI_IMAGE` 
		ADD COLUMN `DESCRIPTION` VARCHAR(45) NULL DEFAULT '1000' COMMENT '이미지 설명' AFTER `MODIFIED_DATE`;
  ...
  CREATE TABLE `AC_UI_TAG_PROPERTY` 
   ...
   ALTER TABLE `AC_UI_COMMENT`  COMMENT '댓글 테이블'; 
    ...
    (
    	...
    	AUD_CLIENT_USERAGENT VARCHAR(255) DEFAULT 'NONE' NOT NULL, -- DEFAULT 'NONE' NOT NULL
