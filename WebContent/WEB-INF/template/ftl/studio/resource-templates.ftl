  ...
  <script>		
	require.config({
  	...
  	require([ "jquery", "bootstrap", "hs.side-nav", "hs.hamburgers" , "hs.dropdown" , "jquery.scrollbar", "hs.scrollbar" , "hs.popup", "studio.custom", "ace" ], function($) {  
		...
		setDataSourceForTree : function(type){   
			var $this = this; 
			var filter = {}; 
			$this.set('type', type );
			if( type === 'script' ){
			...
			community.ui.treeview ($('#resource-treeview')).setDataSource(new kendo.data.HierarchicalDataSource({
				filter : filter,						
				transport: {
	  ...
	  observable.bind("change", function(e) { 
	  	if ( e.field === 'type' ){
	  		if( community.ui.exists( $('#resource-treeview') ) ) { 
				observable.setDataSourceForTree(observable.get('type'));
	  ...
	  var editor = createCodeEditor($("#resource-editor"), observable.get('warp'), "ace/mode/ftl");
	  editor.setReadOnly(!observable.get('editable'));  
  	...
  	function createTreeView(observable){
		...
		if( !community.ui.exists(renderTo) ){  
			...
			var treeview = community.ui.treeview ( renderTo , { 
				dataSource : {					
					transport: {
						read: { url : '<@spring.url "/data/secure/mgmt/resources/template/list.json"/>', dataType: "json" }
					},
					schema: {		
						model: { id: "path", hasChildren: "directory" }
					}
				...
				change: function(e) {
					...
					if( community.ui.defined(filePlaceHolder) ){ 
						community.ui.progress($('#features'), true );
						community.ui.ajax( '<@spring.url "/data/secure/mgmt/resources/" />' + observable.get('type') + '/get.json' ,{
          ...
          <!-- Content -->
			<div id="features" class="container-fluid"  data-bind="visible:visible" style="display:none;"> 
				<header class="card-header g-brd-gray-light-v7 g-bg-transparent g-px-15 g-px-30--sm g-pt-15 g-pt-20--sm g-pb-10 g-pb-15--sm">
					<div class="media">   
						<input data-role="dropdownlist" data-auto-bind="false" data-text-field="text" data-value-field="value" data-bind="value: type, source: typeSource" style="width: 200px;" />  
						<div class="media-body d-flex justify-content-end">  
							<a class="d-flex align-items-center u-link-v5 g-color-gray-light-v6 g-color-secondary--hover g-ml-10 g-ml-15--sm g-ml-30--xl g-mr-10" href="#" data-bind="disabled:editable" >
								<i class="hs-admin-plus g-font-size-18"></i>
								<span class="g-hidden-sm-down g-ml-10">${PAGE_NAME} 새로 만들기</span>
							</a>
						</div>	
					</div>
				</header>	 
				...
				<header class="card-header g-brd-gray-light-v7 g-px-15 g-px-30--sm g-pt-15 g-pt-20--sm g-pb-10 g-pb-15--sm"> 
					<div class="media">
						...
						<div class="media-body d-flex justify-content-end" data-bind="invisible:folder" style="display: none;">   
							...
							<div data-bind="invisible:folder" style="display: none;">
				...
				<!-- start splitter -->
				<div data-role="splitter" style="height: 800px; width: 100%; border:0;" data-panes="[ { collapsible: true, size: '280px', min: '200px', max: '500px' }, { collapsible: false } ]">
						<div class="pane-content">
							<div id="resource-treeview" class="g-pa-5"></div>
						</div>
						<div class="pane-content">
