  	...
  	require([ "jquery", "bootstrap", "hs.side-nav", "hs.hamburgers" , "hs.dropdown" , "jquery.scrollbar", "hs.scrollbar" , "hs.popup", "studio.custom" ], function($) {  
			...
			fields: { 	
			 ...
			 copy : function ( target ){
		    	target.username = this.get("username");
        ...
        <div class="g-pa-20">
          ...
          <div id="features" class="container-fluid"> 
          	...
          	<form id="fm">
				...
				<div class="row g-mb-15">
					<div class="col-md-6 g-mb-10">
						...
						<div class="g-pos-rel">
							...
							<input id="input-username" name="input-username" class="form-control form-control-md g-rounded-4 g-px-14 g-py-10" type="text" placeholder="아이디를 입력하세요" data-bind="value mail.username, enabled:editable" required="" validationmessage="이름을 입력하여 주세요." autofocus="">
						</div>
				...
				<div class="row">
					<div class="col-md-6" data-bind="visible:testable" style="display:none;"> 
						<a href="javascript:void(this);" class="btn btn-md u-btn-3d u-btn-blue g-mr-10 g-mb-15 g-width-200" data-bind="click:testConnection">테스트 연결</a>
					</div>
					<div class="col-md-3 ml-auto text-right" data-bind="visible:editable" style="display:none;">  
						...
						<button class="btn btn-md btn-xl--md u-btn-outline-gray-dark-v6 g-font-size-12 g-font-size-default--md g-mb-10" type="reset">취소</button>
					</div>
				</div>
			</form>
          	<!-- end mail -->
